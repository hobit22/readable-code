...
public class StudyCafePassMachine {
    ...
    private StudyCafeSeatPass selectPass() {
        StudyCafePassType studyCafePassType = ioHandler.getPassTypeSelecting();

        List<StudyCafeSeatPass> passCandidates = findPassCandidateBy(studyCafePassType);
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafeSeatPass selectedPass) {
        ...
        if (lockerPassCandidate.isPresent()) {
            ...
            boolean isLockerSelected = ioHandler.askLockerPassSelection(lockerPass);
